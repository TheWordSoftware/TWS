...
$sql = "INSERT INTO `usuarios`(`nome`, `sexo`, `datanasc`, `telefone`, `email`, `usuario`, `senha`, `periodo`, `curso`, `matricula`, `papel`) VALUES ('$nome', '$sexo', '$datanasc', '$telefone', '$email', '$usuario', '$password', '$periodo', '$curso', '$matricula', '$papel')";
